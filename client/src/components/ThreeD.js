    ...
    onSceneMount = (e) => {
      ...
      */
      ...
      BABYLON.SceneLoader.ImportMesh("", "obj/", "cubesat.obj", scene, function(meshes) {
        ...
        // this.eventEmitter.on('new position', (data) => {
        //   console.log(data);
        //   console.log('whyyyy');
        //   if (this.props.data) { // If data is defined
        //     meshes[0].position = new BABYLON.Vector3(this.props.data.x, this.props.data.y, this.props.data.z); // Set new position of satellite
        //   }
        //
